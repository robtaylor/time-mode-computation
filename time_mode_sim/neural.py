...
from .vmm import TimeVMM, ChainedVMM
from .blocks import FixedWidthPulseGenerator, TimeDomainSubtractor
...
class TimeNeuralLayer:
    ...
    activation: Optional[TimeActivation] = None
...
class TimeNeuralNetwork:
    ...
    def __init__(self, layer_sizes: List[int],
                 activations: Optional[List[TimeActivation]] = None,
                 vmm_params: Optional[dict] = None):
        """
        Initialize network.
...
class RecurrentTimeLayer:
    ...
    def __init__(self, input_size: int, hidden_size: int,
                 output_size: int, vmm_params: Optional[dict] = None):
    ...
    def forward(self, input_sequence: List[List[TimeSignal]]
        ...
        for inputs in input_sequence:
            ...
            new_hidden = []
            for h_i, h_h in zip(h_from_input, h_from_hidden):
